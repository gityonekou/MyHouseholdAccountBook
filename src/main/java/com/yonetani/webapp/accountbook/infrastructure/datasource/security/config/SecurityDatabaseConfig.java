 ...
 *
 */
package com.yonetani.webapp.accountbook.infrastructure.datasource.security.config;
...
public class SecurityDatabaseConfig {
	 ...
	 * 
	 * @return　UserDetailsManager(Bean)
	 */
	@Bean
	UserDetailsManager getJDBCUserDetailsManager() {
