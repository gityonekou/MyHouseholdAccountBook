 ...
 *
 */
package com.yonetani.webapp.accountbook.infrastructure.mapper.account.expenditureinfo;
...
public interface SisyutuItemTableMapper {
	 ...
	 *
	 */
	@Insert("sql/account/expenditureinfo/SisyutuItemTableInsertSql01.sql")
	 ...
	 *
	 */
	@Update("sql/account/expenditureinfo/SisyutuItemTableUpdateSql01.sql")
	 ...
	 *
	 */
	@Update("sql/account/expenditureinfo/SisyutuItemTableUpdateSql02.sql")
	 ...
	 *
	 */
	@Update("sql/account/expenditureinfo/SisyutuItemTableUpdateSql03.sql")
	 ...
	 *
	 */
	@Select("sql/account/expenditureinfo/SisyutuItemTableSelectSql01.sql")
	 ...
	 *
	 */
	@Select("sql/account/expenditureinfo/SisyutuItemTableSelectSql02.sql")
	 ...
	 *
	 */
	@Select("sql/account/expenditureinfo/SisyutuItemTableSelectSql03.sql")
	 ...
	 *
	 */
	@Select("sql/account/expenditureinfo/ParentSisyutuItemMemberNameSelectSql01.sql")
	 ...
	 *
	 */
	@Select("sql/account/expenditureinfo/SisyutuItemTableCountSql01.sql")
