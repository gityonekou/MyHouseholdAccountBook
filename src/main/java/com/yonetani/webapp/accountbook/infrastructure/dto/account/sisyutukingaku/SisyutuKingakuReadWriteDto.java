 ...
 *
 */
package com.yonetani.webapp.accountbook.infrastructure.dto.account.sisyutukingaku;
...
public class SisyutuKingakuReadWriteDto {
	 ...
	 *
	 */
	public static SisyutuKingakuReadWriteDto from(ExpenditureAmountItem domain) {
