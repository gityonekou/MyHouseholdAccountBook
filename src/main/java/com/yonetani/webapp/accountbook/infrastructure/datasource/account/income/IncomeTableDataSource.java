...
public class IncomeTableDataSource implements IncomeTableRepository {
	 ...
	 */
	@Override
	public IncomeItemInquiryList findBy(SearchQueryUserIdAndYearMonth searchQuery) {
		// 検索結果を取得
	 ...
	 */
	@Override
	public TotalAvailableFunds getTotalAvailableFunds(SearchQueryUserIdAndYearMonth searchQuery) {
