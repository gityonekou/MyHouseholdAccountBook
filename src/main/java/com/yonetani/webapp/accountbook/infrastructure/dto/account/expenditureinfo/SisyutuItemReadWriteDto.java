 ...
 *
 */
package com.yonetani.webapp.accountbook.infrastructure.dto.account.expenditureinfo;
...
public class SisyutuItemReadWriteDto {
	 ...
	 *
	 */
	public static SisyutuItemReadWriteDto from(ExpenditureItemInfo domain) {
