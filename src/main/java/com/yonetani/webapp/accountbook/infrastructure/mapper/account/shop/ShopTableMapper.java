...
public interface ShopTableMapper {
	 ...
	 *
	 */
	@Select("sql/account/shop/ShopTableSelectSql06.sql")
	public List<ShopReadWriteDto> findByIdAndShopKubunCode(@Param("dto") UserIdAndShopKubunCodeSearchQueryDto search);
