/**
 * 買い物登録トップメニュー画面表示を担当するコントローラーです。
 * 以下画面遷移を担当します。
 * ・買い物登録トップメニュー画面：家計簿トップメニューからの遷移時(GET)
 * ・買い物登録トップメニュー画面：各月の収支画面からの遷移時(リダイレクト:GET)
 *
 *------------------------------------------------
 * 更新履歴
...
import com.yonetani.webapp.accountbook.application.usecase.account.shoppingregist.ShoppingRegistTopMenuUseCase;
 ...
 * 買い物登録トップメニュー画面表示を担当するコントローラーです。
 * 以下画面遷移を担当します。
 * ・買い物登録トップメニュー画面：トップメニューからの遷移時(GET)
 * ・買い物登録トップメニュー画面：各月の収支画面からの遷移時(リダイレクト:GET)
 *
 *</pre>
 *
...
public class ShoppingRegistTopMenuController {
	...
	/**
	 *<pre>
	 * 買い物登録トップメニュー画面表示のGET要求時マッピングです。
	 ...
	 *
	 */
	@PostMapping(value = "/dispatchaction/", params = "ReturnMonth")
