...
public class FixedCostInfoUpdateForm {
	...
	/**
	 * 相関チェック(支払い月でその他任意を選択した場合、支払い月任意詳細は必須
	 * 
	 * @return その他任意を選択した場合で支払い月任意詳細の設定ありならtrue、空ならfalse
	 */
	@AssertTrue(message = "その他任意が未選択か支払い月任意詳細が未入力です。")
	public boolean isNeedCheckShiharaiTukiOptionalContext() {
		// 支払い月の値がその他任意(40)で支払い月任意詳細が未入力の場合、false
