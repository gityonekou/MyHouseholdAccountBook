...
@ToString
@EqualsAndHashCode
public class SearchQueryUserIdAndPaymentMethodCode {
	// ユーザID
	 ...
	 * @return 検索条件(ユーザID, 支払方法コード)
	 *
	 */
	public static SearchQueryUserIdAndPaymentMethodCode from(UserId userId, PaymentMethodCode paymentMethodCode) {
		return new SearchQueryUserIdAndPaymentMethodCode(userId, paymentMethodCode);
	}
}
