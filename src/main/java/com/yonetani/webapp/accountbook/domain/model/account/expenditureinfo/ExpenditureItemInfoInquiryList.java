...
@Getter
public class ExpenditureItemInfoInquiryList {
	// 支出項目情報のリスト
	private final List<ExpenditureItemInfo> values;
	 ...
	 *
	 */
	public static ExpenditureItemInfoInquiryList from(List<ExpenditureItemInfo> values) {
		if(CollectionUtils.isEmpty(values)) {
			return new ExpenditureItemInfoInquiryList(Collections.emptyList());
		} else {
			return new ExpenditureItemInfoInquiryList(values);
		}
	}
