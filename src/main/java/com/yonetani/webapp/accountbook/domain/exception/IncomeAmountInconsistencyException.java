...
public class IncomeAmountInconsistencyException extends DomainException {
	...
	/**
	 *<pre>
	 * IncomeAmountInconsistencyExceptionクラスのコンストラクターです。
	 *</pre>
	 ...
	 *
	 */
	public IncomeAmountInconsistencyException(String message, Exception cause) {
		super(message, cause);
	}
}
