 ...
 *
 */
package com.yonetani.webapp.accountbook.domain.repository.account.income;
...
public interface IncomeTableRepository {
	 ...
	 *
	 */
	IncomeItemInquiryList findBy(SearchQueryUserIdAndYearMonth searchQuery);
	 ...
	 *
	 */
	TotalAvailableFunds getTotalAvailableFunds(SearchQueryUserIdAndYearMonth searchQuery);
