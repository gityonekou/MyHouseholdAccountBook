 ...
 * 2025/11/18 : 1.00.00  feature-1.00-dev00  新規作成
 * 2026/05/23 : 1.01.00  feature-1.01-dev3   年間固定費合計画面新規追加対応でtoZeroDashString()メソッド追加
 *
 */
...
public abstract class Money {
	...
	/**
	 *<pre>
	 * 金額が0の場合は「ー」、それ以外はフォーマット済み文字列を返却します。
	 * 年間固定費合計画面など、0円を「ー」で表示する用途に使用します。
	 *</pre>
	 * @return 0円の場合"ー"、それ以外はフォーマット済み文字列（例: "10,000円"）
	 *
	 */
