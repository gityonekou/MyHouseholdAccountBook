...
@Getter
public class ExpenditureAmountItemInquiryList {
	// 支出金額情報のリスト
	private final List<ExpenditureAmountItem> values;
	 ...
	 *
	 */
	public static ExpenditureAmountItemInquiryList from(List<ExpenditureAmountItem> values) {
		if(CollectionUtils.isEmpty(values)) {
			return new ExpenditureAmountItemInquiryList(Collections.emptyList());
		} else {
			return new ExpenditureAmountItemInquiryList(values);
		}
	}
