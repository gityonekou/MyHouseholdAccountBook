 ...
 * 2026/04/05 : 1.01.00  feature-1.00-dev00  リファクタリング対応 クラス名をFixedCostShiharaiDayからFixedCostPaymentDayにリネーム
 *
 */
...
@Getter
@EqualsAndHashCode
public class FixedCostPaymentDay {
	// 固定費支払日(支払日)
	 ...
	 *
	 */
	public static FixedCostPaymentDay from(String value) {
		return new FixedCostPaymentDay(value);
	}
