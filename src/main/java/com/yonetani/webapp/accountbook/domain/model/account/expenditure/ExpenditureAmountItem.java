 ...
 * 2025/12/28 : 1.00.00  feature-1.00-dev00  リファクタリング対応(DDD適応)
 *
 */
...
@ToString
@EqualsAndHashCode
public class ExpenditureAmountItem {
	 ...
	 *
	 */
	public static ExpenditureAmountItem from(
			String userId,
			String targetYear,
			String targetMonth,
		...
		return new ExpenditureAmountItem(
				UserId.from(userId),
