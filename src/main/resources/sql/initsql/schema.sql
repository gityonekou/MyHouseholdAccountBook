...
CREATE TABLE IF NOT EXISTS EXPENDITURE_TABLE (
	...
	-- 外部キー:イベントコード
	INDEX EXPENDITURE_EVENT_CODE_INDEX(EVENT_CODE),
	CONSTRAINT FK_EXPENDITURE_EVENT_CODE FOREIGN KEY(USER_ID, EVENT_CODE) REFERENCES EVENT_ITEM_TABLE(USER_ID, EVENT_CODE)
