...
UPDATE FIXED_COST_TABLE SET FIXED_COST_NAME = /*[# mb:p="dto.fixedCostName"]*/ 1 /*[/]*/, FIXED_COST_DETAIL_CONTEXT =  /*[# mb:p="dto.fixedCostDetailContext"]*/ 2 /*[/]*/,
    ...
    FIXED_COST_SHIHARAI_DAY = /*[# mb:p="dto.fixedCostShiharaiDay"]*/ 5 /*[/]*/, SHIHARAI_KINGAKU = /*[# mb:p="dto.shiharaiKingaku"]*/ 6 /*[/]*/
  WHERE USER_ID = /*[# mb:p="dto.userId"]*/ 7 /*[/]*/ AND FIXED_COST_CODE = /*[# mb:p="dto.fixedCostCode"]*/ 8 /*[/]*/
