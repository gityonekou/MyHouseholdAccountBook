...
UPDATE SHOPPING_REGIST_TABLE
  SET SHOP_KUBUN_CODE = /*[# mb:p="dto.shopKubunCode"]*/ 1 /*[/]*/, SHOP_CODE =  /*[# mb:p="dto.shopCode"]*/ 2 /*[/]*/, SHOPPING_DATE = /*[# mb:p="dto.shoppingDate"]*/ 3 /*[/]*/,
      SHOPPING_REMARKS = /*[# mb:p="dto.shoppingRemarks"]*/ 4 /*[/]*/, PAYMENT_METHOD_CODE = /*[# mb:p="dto.paymentMethodCode"]*/ '001' /*[/]*/,
      SHOPPING_FOOD_EXPENSES =  /*[# mb:p="dto.shoppingFoodExpenses"]*/ 5 /*[/]*/, SHOPPING_FOOD_TAX_EXPENSES = /*[# mb:p="dto.shoppingFoodTaxExpenses"]*/ 6 /*[/]*/,
