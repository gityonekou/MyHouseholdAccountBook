...
INSERT INTO EXPENDITURE_TABLE (USER_ID, TARGET_YEAR, TARGET_MONTH, EXPENDITURE_CODE, SISYUTU_ITEM_CODE, EVENT_CODE, EXPENDITURE_NAME, EXPENDITURE_KUBUN, EXPENDITURE_DETAIL_CONTEXT, SIHARAI_DATE, EXPENDITURE_ESTIMATE_KINGAKU, EXPENDITURE_KINGAKU, PAYMENT_METHOD_CODE, DELETE_FLG)
  VALUES (/*[# mb:p="dto.userId"]*/ 1 /*[/]*/, /*[# mb:p="dto.targetYear"]*/ 2 /*[/]*/, /*[# mb:p="dto.targetMonth"]*/ 3 /*[/]*/, /*[# mb:p="dto.sisyutuCode"]*/ 4 /*[/]*/,
          ...
          /*[# mb:p="dto.paymentMethodCode"]*/ '001' /*[/]*/, /*[# mb:p="dto.deleteFlg"]*/ 13 /*[/]*/)
