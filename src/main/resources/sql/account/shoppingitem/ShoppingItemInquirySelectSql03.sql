-- 商品テーブル:SHOPPING_ITEM_TABLE、支出項目テーブル:SISYUTU_ITEM_TABLE、店舗テーブル:SHOP_TABLEから指定のユーザID、商品JANコードを条件に商品情報を検索します。
SELECT A.SHOPPING_ITEM_CODE, A.SHOPPING_ITEM_KUBUN_NAME, A.SHOPPING_ITEM_NAME, A.SHOPPING_ITEM_DETAIL_CONTEXT, A.SHOPPING_ITEM_JAN_CODE, B.SISYUTU_ITEM_NAME,
  ...
  WHERE A.USER_ID = /*[# mb:p="dto.userId"]*/ 1 /*[/]*/ AND A.SHOPPING_ITEM_JAN_CODE = /*[# mb:p="dto.shoppingItemJanCode"]*/ 2 /*[/]*/
