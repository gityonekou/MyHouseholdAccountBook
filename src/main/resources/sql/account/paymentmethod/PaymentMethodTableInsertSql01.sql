...
VALUES (/*[# mb:p="dto.userId"]*/ 1 /*[/]*/, /*[# mb:p="dto.paymentMethodCode"]*/ 2 /*[/]*/, /*[# mb:p="dto.paymentMethodName"]*/ 3 /*[/]*/,
        /*[# mb:p="dto.paymentMethodKubun"]*/ 4 /*[/]*/, /*[# mb:p="dto.bankAccountCode"]*/ 5 /*[/]*/, /*[# mb:p="dto.closingDay"]*/ 6 /*[/]*/,
        /*[# mb:p="dto.paymentMethodSort"]*/ 7 /*[/]*/, /*[# mb:p="dto.enableFlg"]*/ 8 /*[/]*/, /*[# mb:p="dto.enableUpdateFlg"]*/ 9 /*[/]*/)
