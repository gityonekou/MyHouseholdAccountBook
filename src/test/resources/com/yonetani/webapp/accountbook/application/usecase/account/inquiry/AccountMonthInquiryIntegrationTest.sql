...
INSERT INTO EXPENDITURE_TABLE (
    ...
    EXPENDITURE_DETAIL_CONTEXT, SIHARAI_DATE, EXPENDITURE_ESTIMATE_KINGAKU, EXPENDITURE_KINGAKU, PAYMENT_METHOD_CODE, DELETE_FLG
) VALUES
('user01', '2025', '11', '001', '0002', NULL, 'スーパー買い物', '1', '食料品購入', '2025-11-05', 80000.00, 80000.00, '001', false),
('user01', '2025', '11', '002', '0003', NULL, 'レストラン', '1', '外食', '2025-11-10', 30000.00, 30000.00, '001', false),
('user01', '2025', '11', '003', '0005', NULL, '日用品購入', '1', '消耗品', '2025-11-15', 50000.00, 50000.00, '001', false),
('user01', '2025', '11', '004', '0007', NULL, '映画館', '2', '娯楽費', '2025-11-20', 20000.00, 20000.00, '001', false),
('user01', '2025', '11', '005', '0002', NULL, '食材まとめ買い', '1', '食料品購入', '2025-11-25', 100000.00, 100000.00, '001', false);
...
('user01', '2025', '11', '0001', '0001', 220000.00, 210000.00, 150000.00, 30000.00, '2025-11-30'),
('user01', '2025', '11', '0002', '0001', 190000.00, 180000.00, 150000.00, 30000.00, '2025-11-25'),
('user01', '2025', '11', '0003', '0001', 30000.00, 30000.00, 30000.00, NULL, NULL),
...
('user01', '2025', '10', '001', '0002', NULL, '食費', '1', '食料品', '2025-10-15', 100000.00, 100000.00, '001', false),
('user01', '2025', '10', '002', '0005', NULL, '日用品', '1', '消耗品', '2025-10-20', 100000.00, 100000.00, '001', false);
...
('user01', '2025', '09', '001', '0002', NULL, '食費', '1', '食料品', '2025-09-10', 150000.00, 150000.00, '001', false),
('user01', '2025', '09', '002', '0005', NULL, '日用品', '1', '消耗品', '2025-09-15', 100000.00, 100000.00, '001', false),
('user01', '2025', '09', '003', '0007', NULL, '娯楽', '2', '娯楽費', '2025-09-20', 50000.00, 50000.00, '001', false);
...
('user01', '2026', '01', '001', '0002', NULL, 'スーパー買い物', '1', '食料品購入', '2026-01-05', 70000.00, 70000.00, '001', false),
('user01', '2026', '01', '002', '0003', NULL, 'レストラン', '1', '外食', '2026-01-10', 40000.00, 40000.00, '001', false),
('user01', '2026', '01', '003', '0005', NULL, '日用品購入', '1', '消耗品', '2026-01-15', 60000.00, 60000.00, '001', false),
('user01', '2026', '01', '004', '0002', NULL, '食材まとめ買い', '1', '食料品購入', '2026-01-25', 70000.00, 70000.00, '001', false);
