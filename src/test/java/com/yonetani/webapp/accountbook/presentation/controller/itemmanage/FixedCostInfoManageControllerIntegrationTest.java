 ...
 * 2026/05/01 : 1.01.00  feature-1.01-dev2   テストシナリオ⑭、⑮を追加（更新画面からのキャンセル操作のパターン追加）
 * 2026/05/24 : 1.02.00  feature-1.01-dev3   テストシナリオ⑯を追加（年間固定費合計画面表示）
 * 2026/05/27 : 1.02.01  feature-1.01-dev3   テストシナリオ⑰⑱を追加（tabload・月別固定費一覧）
 * 2026/06/13 : 1.03.00  feature-1.02-dev2   テストシナリオ⑲を追加（固定費0円登録対応: @Min(0)バリデーション確認）
 * 2026/06/14 : 1.03.01  feature-1.02-dev2   テストシナリオ⑳㉑を追加（固定費区分=予定支払い金額の場合0円不可: @AssertTrue確認）
 *
 */
