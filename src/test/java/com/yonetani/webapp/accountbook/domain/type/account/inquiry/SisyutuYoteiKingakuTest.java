/**
 * SisyutuYoteiKingaku(支出予定金額)のテストクラスです。
 *
 *------------------------------------------------
 * 更新履歴
 * 日付       : version  コメントなど
 ...
 *
 */
@DisplayName("支出予定金額(SisyutuYoteiKingaku)のテスト")
class SisyutuYoteiKingakuTest {

	@Test
	@DisplayName("正常系：正の金額で生成できる")
	void testFrom_正常系_正の金額() {
		// 実行
		SisyutuYoteiKingaku amount = SisyutuYoteiKingaku.from(new BigDecimal("10000.00"));
	...
	void testFrom_正常系_0円() {
		// 実行
		SisyutuYoteiKingaku amount = SisyutuYoteiKingaku.from(BigDecimal.ZERO.setScale(2));
	...
	void testZERO定数() {
		// 検証
		assertNotNull(SisyutuYoteiKingaku.ZERO);
		assertTrue(SisyutuYoteiKingaku.ZERO.isZero());
		assertEquals(BigDecimal.ZERO.setScale(2), SisyutuYoteiKingaku.ZERO.getValue());
	}
	...
	void testFrom_異常系_null値() {
		...
		MyHouseholdAccountBookRuntimeException exception = assertThrows(
			...
			() -> SisyutuYoteiKingaku.from((BigDecimal)null)
		);
		assertTrue(exception.getMessage().contains("支出予定金額"));
	...
	void testFrom_異常系_負の金額() {
		...
		MyHouseholdAccountBookRuntimeException exception = assertThrows(
			MyHouseholdAccountBookRuntimeException.class,
			() -> SisyutuYoteiKingaku.from(new BigDecimal("-1000.00"))
		);
		assertTrue(exception.getMessage().contains("支出予定金額"));
	...
	void testFrom_異常系_スケール値不正() {
		...
		MyHouseholdAccountBookRuntimeException exception = assertThrows(
			MyHouseholdAccountBookRuntimeException.class,
			() -> SisyutuYoteiKingaku.from(new BigDecimal("10000"))
		);
		assertTrue(exception.getMessage().contains("支出予定金額"));
	...
	void testAdd_正常系() {
		// 準備
		SisyutuYoteiKingaku amount1 = SisyutuYoteiKingaku.from(new BigDecimal("10000.00"));
		SisyutuYoteiKingaku amount2 = SisyutuYoteiKingaku.from(new BigDecimal("5000.00"));

		// 実行
		SisyutuYoteiKingaku result = amount1.add(amount2);
	...
	void testCompareTo_正常系_等しい() {
		// 準備
		SisyutuYoteiKingaku amount1 = SisyutuYoteiKingaku.from(new BigDecimal("10000.00"));
		SisyutuYoteiKingaku amount2 = SisyutuYoteiKingaku.from(new BigDecimal("10000.00"));
	...
	void testCompareTo_正常系_小さい() {
		// 準備
		SisyutuYoteiKingaku amount1 = SisyutuYoteiKingaku.from(new BigDecimal("5000.00"));
		SisyutuYoteiKingaku amount2 = SisyutuYoteiKingaku.from(new BigDecimal("10000.00"));
	...
	void testIsZero() {
		// 検証
		assertTrue(SisyutuYoteiKingaku.ZERO.isZero());
		assertFalse(SisyutuYoteiKingaku.from(new BigDecimal("1.00")).isZero());
	}
	...
	void testIsPositive() {
		// 検証
		assertFalse(SisyutuYoteiKingaku.ZERO.isPositive());
		assertTrue(SisyutuYoteiKingaku.from(new BigDecimal("1.00")).isPositive());
	}

	@Test
	@DisplayName("正常系：isNegativeが正しく動作する（支出予定金額は常にfalse）")
	void testIsNegative() {
		// 検証（支出予定金額は負の値を持てないため、常にfalse）
		assertFalse(SisyutuYoteiKingaku.ZERO.isNegative());
		assertFalse(SisyutuYoteiKingaku.from(new BigDecimal("1.00")).isNegative());
	}
	...
	void testEquals() {
		...
		SisyutuYoteiKingaku amount1 = SisyutuYoteiKingaku.from(new BigDecimal("10000.00"));
		SisyutuYoteiKingaku amount2 = SisyutuYoteiKingaku.from(new BigDecimal("10000.00"));
		SisyutuYoteiKingaku amount3 = SisyutuYoteiKingaku.from(new BigDecimal("5000.00"));
	...
	void testToString() {
		// 準備
		SisyutuYoteiKingaku amount = SisyutuYoteiKingaku.from(new BigDecimal("12345.67"));
	...
	void testToFormatString() {
		// 準備
		SisyutuYoteiKingaku amount1 = SisyutuYoteiKingaku.from(new BigDecimal("12345.67"));
		SisyutuYoteiKingaku amount2 = SisyutuYoteiKingaku.from(new BigDecimal("1000000.00"));
	...
	void testToIntegerValue() {
		...
		SisyutuYoteiKingaku amount1 = SisyutuYoteiKingaku.from(new BigDecimal("12345.67"));
		SisyutuYoteiKingaku amount2 = SisyutuYoteiKingaku.from(new BigDecimal("1000000.00"));
		SisyutuYoteiKingaku amount3 = SisyutuYoteiKingaku.from(new BigDecimal("12345.44"));
		SisyutuYoteiKingaku amount4 = SisyutuYoteiKingaku.from(new BigDecimal("12345.50"));
