...
class IncomeAmountTest {
	...
	void testFrom_正常系_0円() {
		// 実行
		IncomeAmount amount = IncomeAmount.from(BigDecimal.ZERO.setScale(2));
	...
	void testIsZero() {
		// 検証
		assertTrue(IncomeAmount.ZERO.isZero());
		assertFalse(IncomeAmount.from(new BigDecimal("1.00")).isZero());
	}
	...
	void testIsPositive() {
		// 検証
		assertFalse(IncomeAmount.ZERO.isPositive());
		assertTrue(IncomeAmount.from(new BigDecimal("1.00")).isPositive());
	}
	...
	void testIsNegative() {
		...
		assertFalse(IncomeAmount.ZERO.isNegative());
		assertFalse(IncomeAmount.from(new BigDecimal("1.00")).isNegative());
	}
	...
	void testEquals() {
		...
		IncomeAmount amount1 = IncomeAmount.from(new BigDecimal("10000.00"));
		IncomeAmount amount2 = IncomeAmount.from(new BigDecimal("10000.00"));
		IncomeAmount amount3 = IncomeAmount.from(new BigDecimal("5000.00"));
	...
	void testToString() {
		// 準備
		IncomeAmount amount = IncomeAmount.from(new BigDecimal("12345.67"));
	...
	void testToFormatString() {
		// 準備
		IncomeAmount amount1 = IncomeAmount.from(new BigDecimal("12345.67"));
		IncomeAmount amount2 = IncomeAmount.from(new BigDecimal("1000000.00"));
	...
	void testToIntegerValue() {
		...
		IncomeAmount amount1 = IncomeAmount.from(new BigDecimal("12345.67"));
		IncomeAmount amount2 = IncomeAmount.from(new BigDecimal("1000000.00"));
		IncomeAmount amount3 = IncomeAmount.from(new BigDecimal("12345.44"));
		IncomeAmount amount4 = IncomeAmount.from(new BigDecimal("12345.50"));
